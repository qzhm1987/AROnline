...
-(void)startCameraPreview
{
    ...
    if (_cameraPreviewing == NO)
    {
        ...
        UIImage *cloud = [UIImage imageNamed:@"tcloud_symbol1"];
        CGFloat imageWidth;
        ...
        CGSize textSize = [@"" sizeWithAttributes:textAttribute];
        ...
        [@"" drawAtPoint:CGPointMake(imageWidth*1.05, (canvasSize.height - textSize.height) / 2)
