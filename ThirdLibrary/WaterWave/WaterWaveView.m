...
- (CAShapeLayer *)bgLayer
{
    if (!_bgLayer) {
        ...
        _bgLayer.fillColor = rgba(0, 164, 254,0.6f).CGColor;
    }
    return _bgLayer;
}
- (CAShapeLayer *)bgLayer2
{
    if (!_bgLayer2) {
        ...
        _bgLayer2.fillColor =  rgba(0, 164, 254,0.6f).CGColor;
    }
    return _bgLayer2;
}
- (CAShapeLayer *)bgLayer3
{
    if (!_bgLayer3) {
        ...
        _bgLayer3.fillColor =  rgba(0, 164, 254,0.6).CGColor;
    }
    return _bgLayer3;
}
...
- (void)ConfigParams
{
    ...
    _waterWaveHeight = 180;
    
    _waveSpeed1 = 0.01/M_PI;
    _waveSpeed2 = 0.02/M_PI;
    _waveSpeed3 = 0.03/M_PI;
